      ...
      <div className="flex w-full md:flex-row flex-col md:justify-center justify-start items-start relative">
        <div className="flex flex-col justify-between items-start gap-8 md:w-[50%] h-full w-full ">
          <div className="flex flex-col items-start justify-between h-full w-full  mb-[6%]">
            <BodyAnim2 className="text-secondary dark:text-light_text font-[600] lg:text-servicesTech md:text-[4.969vw] text-[7.939vw] leading-[1.3] tracking-tight mb-[1.5%]">
              my tech stack.
            </BodyAnim2>
            <BodyAnim2 className="text-grey2 dark:text-grey3 lg:text-aboutParagraph font-[200] md:text-[2.576vw] text-[5.089vw] leading-[1.4] ">
              Some of my go-to tools used for web development.
            </BodyAnim2>
              ...
              <div className="w-full flex md:hidden justify-between items-start">
                <div className="w-[50%] flex flex-col items-start ">
                  {skills.slice(0, 4).map((skill, index) => (
                    <div
                      className="font-bold text-[6.939vw] leading-[1.2] text-tertiary dark:text-light_text tracking-tight"
                      key={index}
                    >
                      {skill}
                    </div>
          ...
          <div className="flex flex-col justify-start w-full ">
            ...
            <BodyAnim2 className="lg:text-aboutParagraph font-[200] md:text-[2.576vw] text-[5.089vw] text-grey2 dark:text-grey3 leading-[1.4] ">
              See the rest of my skills here.
            </BodyAnim2>
            <BodyAnim>
              <Link
                href="/NickShumResumeJake.pdf"
                target="_blank"
        ...
        >
          {skills.map((skill, index) => (
            <div className={"h-auto relative overflow-y-clip"} key={index}>
              <motion.div
                className="font-[600] lg:text-servicesTech md:text-[4.969vw] text-[6.939vw] leading-[1.2] text-tertiary dark:text-light_text tracking-tight"
                custom={index * 5}
