      ...
      <div className="flex w-full md:flex-row flex-col justify-between items-start">
        <div className="flex flex-col justify-between items-start gap-8 md:w-[50%] h-full w-full">
          <div className="flex flex-col items-start justify-between h-full w-full ">
            ...
            <div className="font-[500] dark:text-grey3 lg:text-[3.125vw] md:text-[3.980vw] text-[7.952vw] text-grey2 leading-[1.2] tracking-tight mb-[6%]">
          ...
          <div className="flex flex-col justify-start w-full ">
            <div className="font-[500] lg:text-[3.125vw] dark:text-grey3 md:text-[3.980vw] text-[7.952vw] text-grey2 leading-[1.2] tracking-tight mb-[6%]">
