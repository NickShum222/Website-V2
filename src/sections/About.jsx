...
const About = () => {
  return (
    <div
      className={`lg:px-[9%] md:px-[64px] px-[24px] py-[12%] flex flex-col justify-start bg-primary dark:bg-secondary w-full`}
    >
      ...
      <div className="flex md:flex-row flex-col md:justify-between justify-center items-start lg:gap-0 md:gap-4 gap-6 relative">
        ...
        <div className="flex flex-col justify-start md:w-[50%] w-full sticky top-[2%]">
          <div className="lg:text-servicesSub md:text-[3.980vw] text-[7.952vw] leading-[1.2] font-[700] text-secondary dark:text-primary">
            Hi! Nice to meet you, I'm Nick Shum.
          </div>
          <div className="flex flex-col justify-normal w-full mt-[3%] lg:gap-6 gap-5 ">
            <div className="text-grey2 lg:text-aboutParagraph font-[300] md:text-[2.576vw] text-[5.089vw] leading-[1.5] ">
