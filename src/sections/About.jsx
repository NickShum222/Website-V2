...
import { Header, TextAnim } from "@/components";
    ...
    >
      ...
      <div className="flex md:flex-row flex-col md:justify-between justify-center items-start lg:gap-0 md:gap-4 gap-6 relative">
        ...
        <div className="flex flex-col justify-start md:w-[50%] w-full sticky top-[2%]">
          <TextAnim className="lg:text-servicesTech md:text-[4.969vw] text-[6.939vw] md:leading-[1.1] leading-[1.2] font-[700] text-secondary dark:text-primary">
            Hi! Nice to meet you, I'm Nick Shum.
          </TextAnim>
          <div className="flex flex-col justify-normal w-full mt-[3%] lg:gap-6 gap-5 ">
            <TextAnim className="text-grey2 dark:text-grey3 lg:text-aboutParagraph font-[300] md:text-[2.576vw] text-[4.589vw] leading-[1.4] ">
